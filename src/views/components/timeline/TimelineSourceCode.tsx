  ...
  return (
    <Timeline position={hiddenMD ? 'right' : 'alternate'}>
      ...
      <TimelineItem>
        <TimelineSeparator>
          <CustomTimelineDot skin='light' color='error'>
            <Icon icon='bx:server' fontSize={20} />
          </CustomTimelineDot>
          <TimelineConnector />
        </TimelineSeparator>
        <TimelineContent>
          ...
          <Box sx={{ ml: 4, display: 'flex', justifyContent: 'space-between' }}>
            <div>
              <IconButton sx={{ color: 'text.primary' }}>
                <Icon icon='bx:share-alt' fontSize={20} />
              </IconButton>
              <IconButton sx={{ color: 'text.primary' }}>
                <Icon icon='bx:refresh' fontSize={20} />
              </IconButton>
            </div>
            <Switch sx={{ mr: 2 }} />
          </Box>
      ...
      <TimelineItem>
        ...
        <TimelineContent>
          <Box sx={{ mb: 2, display: 'flex', flexWrap: 'wrap', alignItems: 'center', justifyContent: 'space-between' }}>
            ...
            <CustomChip rounded size='small' label='High' skin='light' color='error' />
          </Box>
