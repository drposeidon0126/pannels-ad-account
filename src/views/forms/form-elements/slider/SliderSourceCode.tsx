...
const SliderSuccess = styled(MuiSlider)(({ theme }) => ({
  ...
  '& .MuiSlider-thumb.Mui-focusVisible.Mui-active': {
    boxShadow: 0 0 0 10px {hexToRGBA(theme.palette.success.main, 0.16)}
  }
}))
...
const SliderError = styled(MuiSlider)(({ theme }) => ({
  ...
  '& .MuiSlider-thumb.Mui-focusVisible.Mui-active': {
    boxShadow: 0 0 0 10px {hexToRGBA(theme.palette.error.main, 0.16)}
  }
}))
...
const SliderWarning = styled(MuiSlider)(({ theme }) => ({
  ...
  '& .MuiSlider-thumb.Mui-focusVisible.Mui-active': {
    boxShadow: 0 0 0 10px {hexToRGBA(theme.palette.warning.main, 0.16)}
  }
}))
...
const SliderInfo = styled(MuiSlider)(({ theme }) => ({
  ...
  '& .MuiSlider-thumb.Mui-focusVisible.Mui-active': {
    boxShadow: 0 0 0 10px {hexToRGBA(theme.palette.info.main, 0.16)}
  }
}))
